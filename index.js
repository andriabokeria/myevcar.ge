 ...
 * Must stay outside for HTML 'onclick' to work.
 */
let slideIndex = 1;
let slideTimer;
let translations = {};
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // 1. ფუნქცია, რომელიც ტვირთავს ენებს და რთავს სლაიდშოუს
    async function loadTranslations() {
        try {
            ...
            // თუ JSON ვერ ჩაიტვირთა, სლაიდშოუ მაინც ჩაირთოს (fallback)
            showSlides(slideIndex);
            autoSlides();
        }
    }
    ...
    // --- უმნიშვნელოვანესი ნაბიჯი: ყველაფრის გაშვება ---
    loadTranslations();

}); // <-- End of DOMContentLoaded

// Footer opacity logic
